      ...
      <div className="container">
        <div className="search-filters-container">
          ...
          <div className="filters-container">
            ...
            <button className="dropBtn" onClick={handlePrint}>
              <DownloadIcon /> export
            </button>
          </div>
        </div>
            ...
            {users.map((user, index: number) => (
              <tbody key={index}>
                <tr onClick={() => updateUser(user.username)}>
                  ...
                  <td className={display('role') ? '' : 'inactive'}>
                    {user.role}
                  </td>
                  <td className={display('password') ? '' : 'inactive'}>
                    {user.password}
                  </td>
                  <td className={display('created_date') ? '' : 'inactive'}>
                    {user.created_date}
                  </td>
                  <td className={display('username') ? '' : 'inactive'}>
                    {user.username}
                  </td>
                  {/* <td className={display('permissions') ? '' : 'inactive'}>
                    {user.permissions}
                  </td> */}
